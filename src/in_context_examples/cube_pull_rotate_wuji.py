...
Run:
    python cube_pull_rotate_wuji.py
"""
...
_RENDER_EVERY = 8
_FRAMES_DIR = os.environ.get("ISAAC_FRAMES_DIR", "/tmp/isaac_frames_cube_negx_highy_pull_posx_wuji")
...
_HAND_PUSH = {
    "right_finger1_joint1": 0.7,
    "right_finger1_joint2": 0.35,
    "right_finger1_joint3": 0.6,
    "right_finger1_joint4": 0.6,
    "right_finger2_joint1": 0.7,
    "right_finger2_joint2": 0.35,
    "right_finger2_joint3": 0.6,
    "right_finger2_joint4": 0.6,
    "right_finger3_joint1": 0.7,
    "right_finger3_joint2": 0.35,
    "right_finger3_joint3": 0.6,
    "right_finger3_joint4": 0.6,
    "right_finger4_joint1": 0.7,
    "right_finger4_joint2": 0.35,
    "right_finger4_joint3": 0.6,
    "right_finger4_joint4": 0.6,
    "right_finger5_joint1": 0.7,
    "right_finger5_joint2": 0.35,
    "right_finger5_joint3": 0.6,
    "right_finger5_joint4": 0.6,
}
...
# Saved to trajectories/cube_pull_rotate_wuji/ at the end of execution.
_obj_traj: list[dict] = []
...
try:
    ...
    _traj_dir = Path(__file__).parent.parent.parent / "trajectories" / "cube_pull_rotate_wuji"
...
try:
    ...
    if frames:
        _vid = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cube_negx_highy_pull_posx_rotate_wuji.mp4")
        subprocess.run(
            [
