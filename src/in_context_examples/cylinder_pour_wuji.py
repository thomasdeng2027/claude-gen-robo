...
_RENDER_EVERY = 8
_FRAMES_DIR   = os.environ.get("ISAAC_FRAMES_DIR", "/tmp/isaac_frames_cylinder_grasp_wuji")
...
# Saved to trajectories/cylinder_pour_wuji/ at the end of execution.
_obj_traj: list[dict] = []
...
try:
    ...
    _traj_dir = Path(__file__).parent.parent.parent / "trajectories" / "cylinder_pour_wuji"
...
try:
    ...
    if frames:
        _vid = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cylinder_grasp_wuji.mp4")
